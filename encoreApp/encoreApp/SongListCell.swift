...
struct SongListCell: View {
    ...
    func upvote() {
        guard let url = URL(string: "https://api.encore-fm.com/users/"+"\(self.user.username)"+"/vote/"+"\(self.song.id)"+"/up") else {
            print("Invalid URL")
            return
    ...
    func downvote() {
        guard let url = URL(string: "https://api.encore-fm.com/users/"+"\(self.user.username)"+"/vote/"+"\(self.song.id)"+"/down") else {
            print("Invalid URL")
            return
        }
        var request = URLRequest(url: url)
